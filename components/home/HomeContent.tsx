...
import CartSheet, { CartButton } from "../shop/CartSheet";
import ProductCarousel from "../shop/ProductCarousel";
import SectionHeader from "../shop/SectionHeader";
import CategoryShelf from "../shop/CategoryShelf";
import Testimonials from "../shop/Testimonials";
import EmptyShelf from "../shop/EmptyShelf";
import Reveal from "../shop/Reveal";
import HowItWorks from "../shop/HowItWorks";
import StudioStory from "../shop/StudioStory";
import FAQ from "../shop/FAQ";
import SiteFooter from "../site/SiteFooter";

// Data arrives as a prop from the server component in app/page.tsx, already
// resolved. There is no mount fetch and no loading state any more: the shelves
// are present in the very first HTML response, which is what makes them visible
// to crawlers that don't execute JavaScript.
export default function HomeContent({ data }: { data: StorefrontData }) {
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
          <Reveal>
            ...
            <div className="mt-12 grid w-full grid-cols-3 gap-3 sm:gap-4">
              {[
                // Keep these in step with /shipping-returns — that page is the
                // operative policy, and a faster promise here is one we'd be
                // advertising without honouring.
                { value: "100%", label: "Customizable" },
                { value: "1–3 days", label: "Dispatch time" },
          ...
          <Reveal variant="scale" delay={120}>
            <div className="relative">
              ...
              <Image
                src={HeroBanner}
                alt="A collection of ShilpSmith 3D printed pieces — personalized gifts, decor and accessories"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              {
                icon: "⚡",
                title: "Made to order, fast",
                copy: "Most standard pieces are printed and dispatched within 1–3 business days.",
              },
              {
                icon: "🌿",
                title: "Premium materials",
                copy: "Durable PETG and PLA, chosen per piece to survive Indian summers and daily handling.",
              },
              {
                icon: "💬",
